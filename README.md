...
# UnitCare EMR Interface

[UnitCareEMR](https://emr.unitcare.co) is the open source electronic health records and medical practice management solution based of OpenEMR. [ONC certified](https://open-emr.org/wiki/index.php/OpenEMR_Wiki_Home_Page#ONC_Ambulatory_EHR_Certification) with international usage, UnitCare EMR's goal is a superior alternative to its proprietary counterparts.

### Contributing

UnitCareEMR is a leader in healthcare open source software. Costly proprietary EMRs are no longer the only option. [Learn how to start contributing today!](https://open-emr.org/wiki/index.php/FAQ#How_do_I_begin_to_volunteer_for_the_OpenEMR_project.3F)
...
Support this project by becoming a sponsor. Your logo will show up here with a link to your website. [[Become a sponsor](https://unitcare.co/unitcareemr#sponsor)]
